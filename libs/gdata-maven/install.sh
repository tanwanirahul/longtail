...
mvn install:install-file -DgroupId=com.google.gdata -DartifactId=google-collect -Dversion=1.0-rc1 -Dfile=google-collect-1.0-rc1.jar -Dpackaging=jar -DgeneratePom=true

mvn install:install-file -DgroupId=net.sourceforge.wurfl -DartifactId=wurlf-core -Dversion=1.0.1 -Dfile=wurfl-1.0.1.jar -Dpackaging=jar -DgeneratePom=true
